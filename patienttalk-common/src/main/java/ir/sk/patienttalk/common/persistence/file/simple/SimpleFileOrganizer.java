package ir.sk.patienttalk.common.persistence.file.simple;
...
public class SimpleFileOrganizer {
    ...
    public void save(EntityBase entity, String fileName, InputStream stream)
    ...
    public String load(EntityBase entity, String fileName) throws PersistenceException {
     ...
     * @throws PersistenceException
     */
    public List<Path> list(EntityBase entity) throws PersistenceException {
     ...
     * @throws PersistenceException
     */
    public List<Path> list(EntityBase entity, String startWith) throws PersistenceException {
    ...
    @SuppressWarnings("ResultOfMethodCallIgnored")
    public void clear(EntityBase entity) throws PersistenceException {
        if ((entity == null) || (entity.getId() <= 0))
            throw new PersistenceException(PersistenceExceptionType.BadParameter,
                    "parameters for file saving are not completed...");
        Path path = Paths.get(root, entity.getClass().getSimpleName(), String
    ...
    @SuppressWarnings("ResultOfMethodCallIgnored")
    public void clear(EntityBase entity, String startOfFileName)
            throws PersistenceException {
        if ((entity == null) || (entity.getId() <= 0))
            throw new PersistenceException(PersistenceExceptionType.BadParameter,
                    "parameters for file saving are not completed...");
