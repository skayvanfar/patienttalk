package ir.sk.patienttalk.common.persistence.file.pair;
...
public class FileQueryProvider {
    ...
    public void save(EntityBase entity, String resourcePath, String objectName,
    ...
    public ArrayList<FileItem> read(EntityBase entity, String queryString)
    ...
    public FileItem uniqueResult(EntityBase entity, String queryString)
            throws PersistenceException {
    ...
    public void clearPath(EntityBase entity) throws PersistenceException {
        if (entity.getId() < 1)
            throw new PersistenceException(
                    PersistenceExceptionType.Fatal,
                    "I can't set the file. "
    ...
    public void remove(EntityBase entity, String resourcePath, String objectName)
            throws PersistenceException {
        if (entity.getId() < 1)
            throw new PersistenceException(
                    PersistenceExceptionType.Fatal,
