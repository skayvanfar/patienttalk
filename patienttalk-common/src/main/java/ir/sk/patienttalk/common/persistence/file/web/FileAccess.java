package ir.sk.patienttalk.common.persistence.file.web;
...
import ir.sk.patienttalk.common.persistence.file.IFileAccess;
...
public class FileAccess implements IFileAccess {
    ...
    public FileItem save(NamedInput input, boolean replace, EntityBase entity, String... role) throws PersistenceException {
        if (entity.getId() < 1)
    ...
    public FileItem read(EntityBase entity, String... role)
    ...
    public List<FileItem> list(EntityBase entity, String... role)
            throws PersistenceException {
        if (entity.getId() < 1)
            throw new PersistenceException(
                    PersistenceExceptionType.Fatal,
    ...
    public void remove(EntityBase entity, String... role)
            throws PersistenceException {
        if (entity.getId() < 1)
            throw new PersistenceException(
                    PersistenceExceptionType.Fatal,
