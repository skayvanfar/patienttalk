...
<%--@elvariable id="loginData" type="ir.sk.patienttalk.web.logic.data.LoginData"--%>
<%--@elvariable id="basket" type="ir.sk.patienttalk.web.logic.data.BasketSessionData"--%>
<div class="row">
    <a href="<s:url value="/"/>">
    ...
    <div class="left" id="s-header-nav">
        ...
        <ul style="margin-bottom: .9rem">
            ...
            <sec:authorize access="isAuthenticated() and hasAuthority('SUPER_ADMIN')">
                ...
                <li><a href="<s:url value="/manage/production/new"/>">کاربر جدید<i class="icon icon-plus"></i></a></li>
            </sec:authorize>
